...
abstract class $AnnouncementCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String content, String header});
}
...
class _$AnnouncementImpl implements _Announcement {
  _$AnnouncementImpl(
      {required this.id, required this.content, required this.header});
  ...
  @override
  String toString() {
    return 'Announcement(id: $id, content: $content, header: $header)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, content, header);
...
abstract class _Announcement implements Announcement {
  factory _Announcement(
      ...
      required final String header}) = _$AnnouncementImpl;
