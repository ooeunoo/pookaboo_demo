...
class _$AppUserImpl implements _AppUser {
  ...
  @override
  String toString() {
    return 'AppUser(id: $id, email: $email, name: $name, nickname: $nickname, avatar_url: $avatar_url, phone: $phone, gender: $gender, age: $age, created_at: $created_at)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, email, name, nickname,
      avatar_url, phone, gender, age, created_at);
